...
module.exports = {
  PAPERLESS_AI_VERSION: 'HB42 v0.9',
  CONFIGURED: false,
  ...
  // Fix #927/#933: allow temperature to be configured. Some providers
  // (Moonshot / Kimi) reject the upstream-hardcoded 0.3. Empty string
  // = omit parameter entirely. "auto" uses the per-service default.
  aiTemperature: process.env.AI_TEMPERATURE !== undefined ? process.env.AI_TEMPERATURE : '0.3',
